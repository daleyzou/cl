...
<html>
  ...
  <%
	...
	if(currentpage==1){
  	...
  	ArrayList<userreplyEntity> list=rd.getUserReplyByPage(pageSize, currentpage);
...
<script type="text/javascript">
  ...
  <body>
    <div class="panel-heading" id="top_div"><img class="img-circle" id="logo" src="<%=path%>/img/cl.jpg"/><span id="top">评论管理</span></div>
  ...
  %>
    <tr>
      ...
      <div class="btn-group" role="group" >
 		 ...
 		 <a href="admin/reply/reply.jsp?page=<%=currentpage%>&id=<%=m.getR_id()%>"><button type="button" class="btn btn-default" onclick="javascript:return delet(<%=m.getR_id()%>);">删除</button></a>
 	  </div>
      </td>
    </tr>
   <%
  ...
  <ul class="pagination">
    <li>
      <a href="admin/reply/reply.jsp?page=<%=lastpage%>" >
    ...
    %>
    <li><a href="admin/reply/reply.jsp?page=<%=i%>"><%=i %></a></li>
    
    <%
    	}
    %>
    <li>
      <a href="admin/reply/reply.jsp?page=<%=nextpage %>" >
